...
1. Create a new repo named exactly `Abhay2110s` (same as your username) if you don't already have one — this is your special profile repo.
2. In that repo, add `.github/workflows/snake.yml` with:
...
3. Push it, run the workflow once manually (Actions tab → Generate Snake → Run workflow), and the `output` branch will host your live snake SVG.
